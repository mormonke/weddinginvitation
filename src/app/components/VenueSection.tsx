      ...
      <div className="max-w-6xl mx-auto px-6 md:px-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-start">
          ...
          <div className="flex flex-col gap-8">
            ...
            >
             Расположенный в сердце города Бишкек, Jannat Regency сочетает в себе современную элегантность и атмосферу утончённого восточного гостеприимства. Окружённый комфортом и спокойствием, этот отель станет прекрасным местом для нашего особенного дня, где каждая деталь будет наполнена теплом, радостью и атмосферой праздника.
            </p>
